...
| `renga create <タイトル> [--id <N>] [--slug <slug>] [--priority high\|medium\|low] [--area <area>] [--body <テキスト\|-\>] [--milestone <milestone>]` | issue を作成する（`--body -` で標準入力から本文を読む） |
